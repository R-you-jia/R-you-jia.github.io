...
(function (ps) {
    ...
    var MovieClip = /** @class */ (function (_super) {
        ...
        function MovieClip(gameObject) {
            ...
            _this.serializableFields = {
                ...
                keepLastFrame: qc.Serializer.BOOLEAN
            };
        ...
        MovieClip.prototype.awake = function () {
            ...
            if (this.defPlay && this.mcData[this.defActionName] && this.autoPlay) {
            ...
            ps.mainState.add("scenechange", function(uuid){
                ...
                if(_this.scene && _this.scene.uuid === uuid) {
                    if (_this.defPlay && _this.mcData[_this.defActionName] && _this.autoPlay) {
        ...
        MovieClip.prototype.getCurrentScene = function () {
            ...
            while(!(node.parent && node.parent.getScript && node.parent.getScript('ps.VPGamePlay'))) {
              // 兼容幽灵序列帧,没有父节点,一般发生在协同写代码的项目中
              if (!node.parent || !node.parent.getScript) {
                this.scene = null;
                return;
              }
              node = node.parent;
    ...
    MovieClip["__ability"] = 'autoPlay,keepLastFrame';
