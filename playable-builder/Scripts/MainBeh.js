...
var MainBeh = /** @class */ (function (_super) {
    ...
    function MainBeh(gameObject) {
        ...
        _this.serializableFields = {
            ...
            downLoadBtn: qc.Serializer.NODE,
            successBtn: qc.Serializer.NODE,
            failBtn: qc.Serializer.NODE,
            targetNode: qc.Serializer.NODE,
            moveNode: qc.Serializer.NODE
        };
        main = _this;
        return _this;
    }
    ...
    MainBeh.prototype.onStart = function () {
        ...
        //this.downLoadBtn.onDown.add(function () {
            // ps.sendAction(8)
        //});
        this.successBtn.onDown.add(function () {
            // ps.sendAction(5)
        });
        this.failBtn.onDown.add(function () {
            // ps.sendAction(7)
        });
        this.moveNode.text = "x".concat(GAME_CFG.maxSuccess);
        this.targetNode.text = "x".concat(GAME_CFG.totalObstacle);
    };
    /** 试玩结束时的处理 */
